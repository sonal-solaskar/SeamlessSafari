                    ...
                    <div class="img-overlay">
                        ...
                        <?php
                                if(isset($_SESSION['email']) && isset($_SESSION['firstName']) && isset($_SESSION['lastName'])) {
                                    ...
                                    echo "<h1>Hello, {$fname} {$lname} </h1> <p>Welcome to Seamless Safari!</p>";
                                } else {
                                    echo "Session variables not set";
                                }
                            ?>
                            <br>
                        <input type="button" id="edit" onclick="document.location='edit.php'" class="primary-btn" value="Edit Profile">
                        <input type="button" id="edit" onclick="document.location='userbooking.php'" class="primary-btn" value="View Bookings">
                        </div>
                    </div>
                </div>
            </div>
